...
+ 'FN:Ƀɨɏɨn\n' // Nama
+ 'ORG:Ƀɨɏɨn-Bot;\n' // Nama bot
+ 'TEL;type=CELL;type=VOICE;waid=573145096484:+57 314 509 6484\n' // Nomor bot
+ 'END:VCARD' 
...
┃ _Ex : ${prefix}Ephoto 25 .Biyin_
┠⊷️ *${prefix}Textpro list*
┃ _Lista de textpro
┠⊷️ *${prefix}Textpro (code + Texto)*
┃ _Ex : ${prefix}Textpro 55 .Biyin_
┗━━━━━━━━━━━━━━━━━━━━
*〘 IMAGENES 〙*
┏━━━━━━━━━━━━━━━━━━━━
┠⊷️ *${prefix}Cogan*
...
//--Convert stiker to image
				case 'toimg':
					...
					exec(`ffmpeg -i ${medimg} ${ran}`, (err) => {
						...
						buffer = fs.readFileSync(ran)
						Lxa.sendMessage(from, buffer, image, {quoted: mek, caption: 'Biyin-Bot'})
						fs.unlinkSync(ran)
					})
					break
